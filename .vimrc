...
set termguicolors
set background=dark
" Gruvbox tuning (applies only when colorscheme=gruvbox)
...
" => NERDTree
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
autocmd BufEnter * if &buftype == '' && expand('%') != '' | silent! lcd %:p:h | endif
...
" <leader>/ = fuzzy find text in project
nnoremap <silent> <leader>/ :Rg<CR>
" <leader>H = recently opened files
nnoremap <silent> <leader>H :History<CR>

" Ignore .git, node_modules etc. in :Files
let $FZF_DEFAULT_COMMAND = 'rg --files --hidden --follow --glob "!{.git,node_modules,vendor,**/__pycache__}"'

"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" => Which-Key (popup showing leader mappings)
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Trigger which-key popup when pressing leader
nnoremap <silent> <leader> :<c-u>WhichKey ','<CR>
vnoremap <silent> <leader> :<c-u>WhichKeyVisual ','<CR>
" Register descriptions for existing mappings (optional — without this,
" which-key still shows the raw mapping commands)
let g:which_key_map = {
  \ '1' : 'goto tab 1',
  \ '2' : 'goto tab 2',
  \ '3' : 'goto tab 3',
